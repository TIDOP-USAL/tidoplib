...
#define CRSSTOOLS_COMPOUNT_WKT_TAG "COMPD_CS"
#define CRSSTOOLS_COMPOUNT_WKT_HORIZONTAL_CRS_TAG "PROJCS"
#define CRSSTOOLS_COMPOUNT_WKT_VERTICAL_CRS_TAG "VERT_CS"
