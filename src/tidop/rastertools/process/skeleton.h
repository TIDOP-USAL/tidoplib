 ...
 * \ingroup ImgProc
 *
 * \brief Skeleton or Topological skeleton comprises a series of algorithms whose purpose
 * is to reduce a shape to a 'skeleton' that preserves the geometry and the topological
 * properties of the original shape. These algorithms are widely used in image processing
 * for shape analysis, object recognition, and morphological analysis. 
 * 
 * The skeletonization process reduces complex shapes to simpler, more manageable structures 
 * while retaining essential features such as connectivity and boundary characteristics.
 * 
 * \{
 */
