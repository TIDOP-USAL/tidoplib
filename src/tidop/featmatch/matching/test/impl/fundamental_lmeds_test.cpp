...
#include "fundamental_lmeds_test.h"
...
FundamentalLMedsTest::FundamentalLMedsTest()
  : GeometricTest(GeometricTest::Type::fundamental_lmeds)
{
}

void FundamentalLMedsTest::setProperties(const GeometricTest::Properties *properties)
{
    if (const LMedsTestProperties *_properties = static_cast<const LMedsTestProperties *>(properties))
        mProperties = *_properties;
}

inline auto FundamentalLMedsTest::exec(const std::vector<cv::Point2f> &points1,
