...
#include "fundamental_8_points_test.h"
...
Fundamental8PointsTest::Fundamental8PointsTest()
  : GeometricTest(GeometricTest::Type::fundamental_eight_points)
{
}

auto Fundamental8PointsTest::exec(const std::vector<cv::Point2f> &points1, 
                                  const std::vector<cv::Point2f> &points2) -> std::vector<unsigned char>
{
    ...
    try {
        ...
        cv::findFundamentalMat(points1, points2, inliers, cv::FM_8POINT);
