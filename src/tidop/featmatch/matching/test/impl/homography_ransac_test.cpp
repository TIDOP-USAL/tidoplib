...
#include "homography_ransac_test.h"
...
HomographyRANSACTest::HomographyRANSACTest()
  : GeometricTest(GeometricTest::Type::homography_ransac)
{
}

void HomographyRANSACTest::setProperties(const GeometricTest::Properties *properties)
{
    if (const RANSACTestProperties *_properties = static_cast<const RANSACTestProperties *>(properties))
        mProperties = *_properties;
}

auto HomographyRANSACTest::exec(const std::vector<cv::Point2f> &points1, 
