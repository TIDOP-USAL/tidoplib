...
public:
    ...
    //template <typename T>
    //auto properties() const -> const T *
    //{
    //    auto props = static_cast<const T *>(properties());
    //    if (!props) {
    //        throw std::bad_cast();
    //    }
    //    return props;
...
/*!
 * \brief Base class for feature types with type flag support.
 */
...
public:
    ...
    /*!
     * \brief Get the type of the feature with flags.
...
//class TL_EXPORT FeatureFactory
//{
//public:
//
//    static auto create(Feature::Type type, const Feature::Properties *properties = nullptr) -> std::shared_ptr<Feature>;
//};
