...
class Evaluator<VecMulScalarExpr<LHS, Scalar>>
{
...
public:
    ...
    using value_type = typename VecMulScalarExpr<LHS, Scalar>::value_type;

public:

    Evaluator(const VecMulScalarExpr<LHS, Scalar> &expr)
      : mLhs(expr.lhs()),
        mScalar(expr.scalar())
    {
    }
