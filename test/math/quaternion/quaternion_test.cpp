...
{
  BOOST_CHECK_EQUAL(1.f, q_uninitialized.w());
  BOOST_CHECK_EQUAL(0.f, q_uninitialized.x());
  BOOST_CHECK_EQUAL(0.f, q_uninitialized.y());
  BOOST_CHECK_EQUAL(0.f, q_uninitialized.z());

  BOOST_CHECK_EQUAL(1., q_d_uninitialized.w());
  BOOST_CHECK_EQUAL(0., q_d_uninitialized.x());
  BOOST_CHECK_EQUAL(0., q_d_uninitialized.y());
  BOOST_CHECK_EQUAL(0., q_d_uninitialized.z());
}
