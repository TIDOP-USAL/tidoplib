...
{
    auto affine = HelmertEstimator<double, 2>::estimate(src_points, dst_points);
...
//BOOST_FIXTURE_TEST_CASE(helmert2d_estimate_matrix, AffineTest)
//{
//    auto affine = HelmertEstimator<double, 2>::estimate(src_mat, dst_mat);
//
//    BOOST_CHECK_CLOSE(0.20478801107224795, affine(0, 0), 0.1);
//    BOOST_CHECK_CLOSE(-0.17207293090531381, affine(0, 1), 0.1);
//    BOOST_CHECK_CLOSE(150.0, affine(0, 2), 0.1);
