...
struct RotationConverterTest
{
    ...
    void setup()
    {
        ...
        aa = AxisAngle<double>(1., {1., 1., 1.});
        aa_x = AxisAngle<double>(1., {1., 0., 0.});
        aa_y = AxisAngle<double>(2., {0., 1., 0.});
        aa_z = AxisAngle<double>(1.5, {0., 0., 1.});
        aa_1 = AxisAngle<double>(1.32, {3.5, 23.1, 45.3});
        //aa.setAngle(1);
        //aa.setAxis({1,1,1});
...
BOOST_FIXTURE_TEST_CASE(quaternion_cero_To_axis_Angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(1., axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_j_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(1., axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_k_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(1., axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.3162278, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(-0.9486833, axis_angle.z(), 0.01);
...
BOOST_FIXTURE_TEST_CASE(matrix_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-0.1690308, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(-0.5070926, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.8451542, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xyz_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.4090649, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.2361737, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.8814124, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xzy_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.1327882, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(-0.858356, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.495572, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yxz_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(2.2213944, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.495572, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.132788, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(-0.8583563, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yzx_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.6054406, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.881412, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.409065, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.236174, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zxy_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.6054406, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.236174, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.881412, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.409065, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zyx_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-0.858356, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.495572, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.132788, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xyx_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.302905, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yxy_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.14159, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.302905, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(-0.673887, axis_angle.z(), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zxz_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.673887, axis_angle.x(), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.y(), 0.01);
    BOOST_CHECK_CLOSE(0.302905, axis_angle.z(), 0.01);
}
