...
BOOST_FIXTURE_TEST_CASE(quaternion_cero_to_matrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(1., rot_mat.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(1., rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(1., rot_mat.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_to_matrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-19., rot_mat.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(12., rot_mat.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(4., rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(-12, rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-17, rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-6, rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-4., rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-6., rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-1., rot_mat.at(2, 2), 0.01);

    rot_mat = q.normalize();
    BOOST_CHECK_CLOSE(-0.4285714, rot_mat.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.8571429, rot_mat.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.2857143, rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.8571429, rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.2857143, rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.4285714, rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.2857143, rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.4285714, rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(0.8571429, rot_mat.at(2, 2), 0.01);
...
BOOST_FIXTURE_TEST_CASE(quaternion_cero_To_axis_Angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(1., axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_i_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(3.1415926535897931, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(1., axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_j_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(3.1415927, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(1., axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_k_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(1., axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(quaternion_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.3162278, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(-0.9486833, axis_angle.axis(2), 0.01);

    axis_angle = q.normalize();
    BOOST_CHECK_CLOSE(2.0137074, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0., axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.3162278, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(-0.9486833, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(matrix_to_axis_angle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(3.4764888, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(-0.1690308, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(-0.5070926, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.8451542, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_angle_to_matrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.6935349, rot_mat.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.3325909, rot_mat.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.6390561, rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.6390561, rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(0.6935349, rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.3325909, rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.3325909, rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0.6390561, rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(0.6935349, rot_mat.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_x_angle1_to_matrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(0.5403023, rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.8414710, rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0.8414710, rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(0.5403023, rot_mat.at(2, 2), 0.01);
}

BOOST_FIXTURE_TEST_CASE(AxisYAngle2ToMatrix, RotationConverterTest)
{
    RotationMatrix<double> rot_mat = aa_y;
    BOOST_CHECK_CLOSE(-0.4161468, rot_mat.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.9092974, rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(1., rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.9092974, rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.4161468, rot_mat.at(2, 2), 0.01);
}

BOOST_FIXTURE_TEST_CASE(AxisZAngle1_5ToMatrix, RotationConverterTest)
{
    RotationMatrix<double> rot_mat = aa_z;
    BOOST_CHECK_CLOSE(0.0707372, rot_mat.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.9974950, rot_mat.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.9974950, rot_mat.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(0.0707372, rot_mat.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0., rot_mat.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(1., rot_mat.at(2, 2), 0.01);
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xyz_to_RotationMatrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-0.5773503, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.5773503, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.5773503, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.2113249, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.7886751, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0.5773503, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0.7886751, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0.2113249, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(0.5773503, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xzy_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.5773503, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.211325, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.788675, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0.788675, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.211325, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yxz_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.211325, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.788675, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.788675, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0.211325, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yzx_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.788675, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.211325, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.211325, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.788675, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zxy_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.788675, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.211325, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.211325, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(0.57735, rotation_matrix.at(1, 1), 0.01);
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zyx_to_RotationMatrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.211325, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.211325, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0.788675, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.57735, rotation_matrix.at(2, 2), 0.01);
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xyx_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.816497, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.0917516, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0.908248, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0.908248, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.0917517, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xzx_to_RotationMatrix, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.408248, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.0917517, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.908248, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.908248, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.0917516, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yxy_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.0917516, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.908248, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.816497, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.408248, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(-0.908248, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.408248, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.0917517, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yzy_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.0917517, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.908248, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.816497, rotation_matrix.at(1, 1), 0.01);
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zxz_to_RotationMatrix, RotationConverterTest)
{
    ...
    RotationMatrix<double> rotation_matrix = eulerAngles;
    BOOST_CHECK_CLOSE(-0.0917516, rotation_matrix.at(0, 0), 0.01);
    BOOST_CHECK_CLOSE(0.908248, rotation_matrix.at(0, 1), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(0, 2), 0.01);
    BOOST_CHECK_CLOSE(0.908248, rotation_matrix.at(1, 0), 0.01);
    BOOST_CHECK_CLOSE(-0.0917517, rotation_matrix.at(1, 1), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(1, 2), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(2, 0), 0.01);
    BOOST_CHECK_CLOSE(0.408248, rotation_matrix.at(2, 1), 0.01);
    BOOST_CHECK_CLOSE(-0.816497, rotation_matrix.at(2, 2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xyz_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(3.6054406, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.4090649, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.2361737, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.8814124, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xzy_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(2.2213944, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.1327882, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(-0.858356, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.495572, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yxz_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(2.2213944, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.495572, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.132788, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(-0.8583563, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yzx_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.6054406, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.881412, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.409065, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.236174, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zxy_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.6054406, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.236174, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.881412, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.409065, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zyx_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(2.22139, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(-0.858356, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.495572, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.132788, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_xyx_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.14159, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.302905, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_yxy_to_AxisAngle, RotationConverterTest)
{
    ...
    AxisAngle<double> axis_angle = eulerAngles;
    BOOST_CHECK_CLOSE(3.14159, axis_angle.angle(), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.302905, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(-0.673887, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(EulerAngles_zxz_to_AxisAngle, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.673887, axis_angle.axis(0), 0.01);
    BOOST_CHECK_CLOSE(0.673887, axis_angle.axis(1), 0.01);
    BOOST_CHECK_CLOSE(0.302905, axis_angle.axis(2), 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(MatrixZeroToEulerAnglesXYZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(MatrixZeroToEulerAnglesZXZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(consts::pi<double>, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(consts::half_pi<double>, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(MatrixZeroToEulerAnglesZYZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(consts::half_pi<double>, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(consts::pi<double>, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(MatrixOnesToEulerAngles, RotationConverterTest)
{
  ...
  //BOOST_CHECK_CLOSE(2.356194490192345, eulerAngles.x, 0.01);
  //BOOST_CHECK_CLOSE(2.5261129449194057, eulerAngles.y, 0.01);
  //BOOST_CHECK_CLOSE(0.7853981633974483, eulerAngles.z, 0.01);

  //eulerAngles.axes = EulerAngles<double>::Axes::xzy;
  //RotationConverter<double>::convert(rot_ones, eulerAngles);
  //BOOST_CHECK_CLOSE(0.78539816339744828, eulerAngles.x, 0.01);
  //BOOST_CHECK_CLOSE(-0.61547970867038726, eulerAngles.y, 0.01);
  //BOOST_CHECK_CLOSE(0., eulerAngles.z, 0.01);
  ...
  //RotationConverter<double>::convert(rot_ones, eulerAngles);
  //BOOST_CHECK_CLOSE(2.3561944901923448, eulerAngles.x, 0.01);
  //BOOST_CHECK_CLOSE(2.5261129449194057, eulerAngles.y, 0.01);
  //BOOST_CHECK_CLOSE(0.78539816339744828, eulerAngles.z, 0.01);
  ...
  //RotationConverter<double>::convert(rot_ones, eulerAngles);
  //BOOST_CHECK_CLOSE(2.3561944901923448, eulerAngles.x, 0.01);
  //BOOST_CHECK_CLOSE(0.95531661812450930, eulerAngles.y, 0.01);
  //BOOST_CHECK_CLOSE(-0.78539816339744828, eulerAngles.z, 0.01);
...
BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesXYZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(1.1071487, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.111341, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.6779451, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesXZY, RotationConverterTest)
{
    EulerAngles<double, Axes::xzy> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-2.0899424, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.460554, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-3.0172377, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesYXZ, RotationConverterTest)
{
    EulerAngles<double, Axes::yxz> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-0.2449786, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1.0949141, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.896614, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesYZX, RotationConverterTest)
{
    EulerAngles<double, Axes::yzx> eulerAngles = rot;
    BOOST_CHECK_CLOSE(2.6779451, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.111341, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(2.0344439, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesZXY, RotationConverterTest)
{
    EulerAngles<double, Axes::zxy> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-2.3561945, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.8911225, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0.7853982, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesZYX, RotationConverterTest)
{
    EulerAngles<double, Axes::zyx> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-3.0172377, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.460554, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-1.0516502, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesZXZ, RotationConverterTest)
{
    EulerAngles<double, Axes::zxz> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-0.124354980700608, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1.11024238472747, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.62244659472789, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesXYX, RotationConverterTest)
{
    EulerAngles<double, Axes::xyx> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-0.244978663126864, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(2.66571042818294, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(1.81577498992176, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesYZY, RotationConverterTest)
{
    EulerAngles<double, Axes::yzy> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-2.0899423856568, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(2.03135026886233, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-1.6951513074955, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesZYZ, RotationConverterTest)
{
    EulerAngles<double, Axes::zyz> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-1.6951513074955045, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1.1102423847274674, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-1.0516502679329891, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesXZX, RotationConverterTest)
{
    EulerAngles<double, Axes::xzx> eulerAngles = rot;
    BOOST_CHECK_CLOSE(-1.8157749899217608, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(2.6657104281829396, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.8966139904629289, eulerAngles.z, 0.01);
}

BOOST_FIXTURE_TEST_CASE(MatrixToEulerAnglesYXY, RotationConverterTest)
{
    EulerAngles<double, Axes::yxy> eulerAngles = rot;
    BOOST_CHECK_CLOSE(2.6224465947278857, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(2.0313502688623259, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-0.12435498070060774, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionIToEulerAnglesZXZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0., eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(consts::pi<double>, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0., eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesXYZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.46364760900080615, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.28975170143604750, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.0344439357957027, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesXZY, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-2.1587989303424644, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-1.0296968008377509, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(2.5535900500422257, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesYXZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.32175055439664224, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.44291104407363896, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-1.8925468811915389, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesYZX, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(2.5535900500422257, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-1.0296968008377509, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(2.1587989303424644, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesZXY, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-1.8925468811915389, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.44291104407363896, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0.32175055439664224, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesZYX, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-2.0344439357957027, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.28975170143604750, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-0.46364760900080615, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesZXZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.58800260354756761, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.54109952595714583, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.5535900500422257, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesXYX, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-1.2490457723982544, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(2.0137073708685356, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(1.2490457723982544, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesYZY, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-2.6779450445889870, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1.8605480282309441, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.6779450445889870, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesZYZ, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-0.98279372324732905, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.54109952595714583, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-0.98279372324732905, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesXZX, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-2.8198420991931510, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(2.0137073708685356, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(2.8198420991931510, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(QuaternionToEulerAnglesYXY, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(2.0344439357957027, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1.8605480282309441, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-1.1071487177940904, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_angle_to_euler_angles_xyz, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-0.785398007, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0.6154796765, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.35619448, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_angle_to_euler_angles_xzy, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(2.8797933085288911, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.61547961750338809, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(2.3561944384602875, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_angle_to_euler_angles_yxz, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0.7853981, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.6154796, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.8797933, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_angle_to_euler_angles_yzx, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(-2.2027107, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(-0.2129303, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-2.5096784, eulerAngles.z, 0.01);
}
...
//    BOOST_CHECK_CLOSE(, eulerAngles.x, 0.01);
//    BOOST_CHECK_CLOSE(, eulerAngles.y, 0.01);
//    BOOST_CHECK_CLOSE(, eulerAngles.z, 0.01);
//}
...
BOOST_FIXTURE_TEST_CASE(axis_x_angle1_euler_angles_xyz, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(1, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_x_angle1_euler_angles_yxz, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_x_angle1_euler_angles_yzx, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(0, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(0, eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(1, eulerAngles.z, 0.01);
}
...
BOOST_FIXTURE_TEST_CASE(axis_x_angle1_euler_angles_yzy, RotationConverterTest)
{
    ...
    BOOST_CHECK_CLOSE(1.5707963267948966, eulerAngles.x, 0.01);
    BOOST_CHECK_CLOSE(1., eulerAngles.y, 0.01);
    BOOST_CHECK_CLOSE(-1.5707963267948966, eulerAngles.z, 0.01);
}
