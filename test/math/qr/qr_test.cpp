...
BOOST_FIXTURE_TEST_CASE(default_constructor, QrTest)
{
  ...
  Matrix<double> qr = qr2->q();
  Matrix<double> r2 = qr2->r();

  BOOST_CHECK_CLOSE(-0.85714285714285721, qr.at(0, 0), 0.1);
  BOOST_CHECK_CLOSE(0.39428571428571429, qr.at(0, 1), 0.1);
  BOOST_CHECK_CLOSE(0.33142857142857141, qr.at(0, 2), 0.1);
  BOOST_CHECK_CLOSE(-0.42857142857142855, qr.at(1, 0), 0.1);
  BOOST_CHECK_CLOSE(-0.902857142857142915, qr.at(1, 1), 0.1);
  BOOST_CHECK_CLOSE(-0.034285714285714280, qr.at(1, 2), 0.1);
  BOOST_CHECK_CLOSE(0.28571428571428570, qr.at(2, 0), 0.1);
  BOOST_CHECK_CLOSE(-0.17142857142857137, qr.at(2, 1), 0.1);
  BOOST_CHECK_CLOSE(0.94285714285714295, qr.at(2, 2), 0.1);


  BOOST_CHECK_CLOSE(-14, r2.at(0, 0), 0.1);
  BOOST_CHECK_CLOSE(-21, r2.at(0, 1), 0.1);
  BOOST_CHECK_CLOSE(14, r2.at(0, 2), 0.1);
  BOOST_CHECK_CLOSE(0, r2.at(1, 0), 0.1);
  BOOST_CHECK_CLOSE(-175, r2.at(1, 1), 0.1);
  BOOST_CHECK_CLOSE(70, r2.at(1, 2), 0.1);
  BOOST_CHECK_CLOSE(0, r2.at(2, 0), 0.1);
  BOOST_CHECK_CLOSE(0, r2.at(2, 1), 0.1);
  BOOST_CHECK_CLOSE(-35, r2.at(2, 2), 0.1);
}
