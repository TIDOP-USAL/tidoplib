...
{\em vf} & Frame de video \\
\hline
{\em skip} & Tipo de salto de video aplicado \\
\hline
{\em nskip} & Número de salto \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Devuelve}
Verdadero si encuentra frame 
...
\begin{DoxyParams}{Parámetros}
{\em rf} & Región de recorte del frame \\
\hline
{\em keep\+Ratio} & Mantiene las dimensiones \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em sz} & Tamaño de salida de video \\
\hline
{\em rf} & Redimensión, recorte o tamaño original del video \\
\hline
{\em keep\+Ratio} & Mantiene las dimensiones \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em ev\+\_\+pc} & Función que escucha el evento \\
\hline
{\em userdata} & Puntero a datos de usuario \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em ev\+\_\+r} & Función que escucha el evento \\
\hline
{\em userdata} & Puntero a datos de usuario \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em ev\+\_\+s} & Función que escucha el evento \\
\hline
{\em userdata} & Puntero a datos de usuario \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em Verdadero} & para activar el salto de frames borrosos \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em ms} & Número de milisegundos que salta \\
\hline
\end{DoxyParams}
