...
{\em wname} & Nombre de la ventana de video \\
\hline
{\em flags} & \\
\hline
{\em b\+Pos} & Muestra slider con posición del video \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parámetros}
{\em trackbarname} & Nombre del trackbar \\
\hline
{\em value} & Puntero opcional a una variable entera cuyo valor representa la posición del slider. \\
\hline
{\em count} & Posición máxima del slider \\
\hline
{\em on\+Change} & Manejador del evento on\+Change. \\
\hline
{\em userdata} & Puntero para pasar parametros al manejador del evento on\+Change. \\
\hline
\end{DoxyParams}
