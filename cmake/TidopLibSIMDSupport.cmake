...
function(set_architecture architecture)
    ...
    if(${architecture} STREQUAL "AVX512")
        set(TL_HAVE_AVX512F TRUE PARENT_SCOPE)
        set(TL_HAVE_AVX512VL TRUE PARENT_SCOPE)
        set(TL_HAVE_AVX512BW TRUE PARENT_SCOPE)
        set(TL_HAVE_AVX512DQ TRUE PARENT_SCOPE)
    ...
    elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang|AppleClang")
        if(${architecture} STREQUAL "AVX512")
            ADD_DEFINITIONS(-mavx512f -mavx512vl -mavx512bw -mavx512dq)
        elseif(${architecture} STREQUAL "AVX2")
